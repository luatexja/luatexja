...
あああaaa$\hbox{\cleaders\hbox{a}\hskip1em x}a\rightarrow a\xrightarrow{aaa}b\cleaders\hbox{a}\hskip1em b$ あいう\cleaders\hbox{a}\hskip10emあ

a$a\hbox to 3\zw{\arrowfill@\leftarrow \relbar\rightarrow{a}}a\smash{a}$
