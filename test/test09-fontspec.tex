...
\jfontspec[BoldFont=HaranoAjiGothic-Bold.otf]{HaranoAjiGothic-Light.otf}
\fontspec[BoldFont=texgyrebonum-bold.otf]{texgyrebonum-regular.otf}
{ABCあいうえお}\par
{\addjfontfeatures{FakeBold=2}\addfontfeatures{FakeBold=2}ABCあいうえお}\par% 欧文は問題なし
{\addjfontfeatures{FakeBold=8}\addfontfeatures{FakeBold=8}ABCあいうえお}\par% 欧文は問題なし
{\addjfontfeatures{FakeBold=8}ABCあいうえお}
\end{document}
