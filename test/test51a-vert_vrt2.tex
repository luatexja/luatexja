...
%  あ\vrule ㍗
  \smash{\llap{\vrule depth 100pt width 0.1mm\kern-0.05mm}}%
  左%
  \smash{\rlap{\kern-0.05mm\vrule depth 100pt width 0.1mm}}%
  ←↑↓→☜☝☟☞⇦⇧⇩⇨⬅⬆⬇➡右¶\ltjjachar"253B\ltjjachar"0165\relax
  あ：いーう，え、お．か。き；け\ltjjachar"201Cこ\ltjjachar"301D%
  さ\ltjjachar"301Fゃ\ltjjachar"201Dす\ltjjachar"2015せ\ltjjachar"2014そ
  ‥…〜ー＝―‐゠㍉㌔㌢㍍㌘㌧㌃㌶㍑㍗㌍㌦㌣㌫㍊㌻㍿㍾㍽㍼㍻＝≒≠≡\ltjjachar`β%
  \ltjjachar`Å\ltjjachar`Бあっと\ltjjachar"205D…‥あ
}


\TESTA{MogaMincho}
\TESTA{IPAexMincho}
\TESTA{HGSeiKaishotai-PRO}
\TESTA{hgrsmp04.ttf}
