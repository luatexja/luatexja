...
% \caption{Details of the output of \pTeX in the case of (1) in Table~\ref{tab-jfmglue}.} のほうがよい？
\label{fig-ptexjfm}
\end{figure}
...
By the way, around a \emph{glyph\_node} $p$ there may be some nodes
	   ...
	   \pTeX\ (p3.2). This explains (2) in the figure.
           % - p3.2 というのは pTeX のバージョン？　(version~p3.2) くらいに補ったほうがよいかも．
           % - in the figure は指している場所がわからずつらいだろう．面倒でも in Table~\reftab-jfmglue{} のほうがふさわしいだろう．
