...
-- 3 のみ四分，あとは0
	 ...
	 [2] = { 0, 0, 0, ksp_stretch=1, ksp_shrink=1 },
...
-- 3 は四分, 2, 4, 9 は0, あとは0.5
	 ...
	 [3] = { 0.25, 0.0, 0.25, priority=1, ratio=1 },
         [4] = { 0, 0, 0, ksp_shrink=1 },
	 [5] = { 0.5 , 0.0, 0.5, rario=0, ksp_stretch=1 },
	 [6] = { 0.5 , 0.0, 0.5, rario=0, ksp_stretch=1 },
	 [7] = { 0.5 , 0.0, 0.5, rario=0, ksp_stretch=1 },
	 [8] = { 0.5 , 0.0, 0.5, rario=0, ksp_stretch=1 },
      }
   },
...
-- 3 は.75, 2, 4 は0, あとは0.5
   ...
   [6] = { -- 感嘆符・疑問符
      ...
      width = 1.0, height = 0.50, depth = 0.50, italic=0.0,
      glue = {
         [0] = { 1.0 , 0.0, 0.5, ratio=1, ksp_stretch=1 },
	 [1] = { 0.5 , 0.0, 0.5, ratio=1, ksp_stretch=1 },
	 [2] = { 0, 0, 0, ksp_shrink=1 },
